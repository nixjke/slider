...
import { constants, defaultModel, defaultVisualModel } from '../../../../utils/constants'
import { GState, VisualState, IState } from '../../../../utils/interface'

class Settings extends Observer {
  public wrapper: HTMLFormElement
  private state: GState = {}
  private model: IState = defaultModel
  ...
  public setState(model: IState, visualModel: VisualState) {
  ...
  private handleChangeSettings(e: Event) {
    ...
    if (target.tagName === 'INPUT') {
      ...
      this.notify('reCreateApp', { [target.name]: value })
    }
  }
}
