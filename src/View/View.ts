import Settings from './Factories/SubView/Settings/Settings'
import Template from './Factories/SubView/Template/Template'
import { Factory } from './Factories/Factories'
import { Observer } from '../Observer/Observer'
import { constants } from '../utils/constants'
import { ForMouseMove, ViewValues, UI, VisualState } from '../utils/interface'
...
class App extends Observer {
  ...
  constructor(private factory: Factory, private anchor: HTMLElement) {
    super()
  }
  ...
  public init(state: VisualState) {
    ...
    this.notify('finishInit', { handles, edge })
  }
  ...
  private handleMouseMove(this: App, forMouseMove: ForMouseMove, e: MouseEvent) {
    ...
    this.notify('onUserMove', { left, target: isBar ? this.closestHandle : target })
  }
}
